...
const ImagesMobile2: React.FC = () => {
	...
	return (
		<div className={styles.images}>
			<div ref={imageRef1}>
				<Image src='/xr-suits/images/1.webp' alt='xr-suit' width={500} height={650} />
			</div>
			<div ref={imageRef2}>
				<Image src='/xr-suits/images/2.webp' alt='xr-suit' width={500} height={650} />
			</div>
			<div ref={imageRef3}>
				<Image src='/xr-suits/images/3.webp' alt='xr-suit' width={500} height={650} />
			</div>
		</div>
	);
};
